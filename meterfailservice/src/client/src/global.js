    ...
    "main": {
        "fa": {
            ...
            "numbers": {
                ...
                "minimalPairs": {
                    "pluralMinimalPairs-count-one": "او {0} فیلم در هفته می‌بیند که کمدی است.",
                    "pluralMinimalPairs-count-other": "او {0} فیلم در هفته می‌بیند که کمدی هستند.",
        ...
        "fa": {
            ...
            "dates": {
                "timeZoneNames": {
                    ...
                    "regionFormat": "وقت {0}",
                    "regionFormat-type-daylight": "وقت تابستانی {0}",
                    "regionFormat-type-standard": "وقت عادی {0}",
                    "fallbackFormat": "{1} ({0})",
                    "zone": {
                        "America": {
                            "Adak": {
                    ...
                    "metazone": {
                        ...
                        "Mexico_Northwest": {
                            "long": {
                                "generic": "وقت شمال غرب مکزیک",
                                "standard": "وقت عادی شمال غرب مکزیک",
                                "daylight": "وقت تابستانی شمال غرب مکزیک"
                            }
                        },
                        "Mexico_Pacific": {
                            "long": {
                        ...
                        "New_Zealand": {
                            "long": {
                                "generic": "وقت زلاند نو",
                                "standard": "وقت عادی زلاند نو",
                                "daylight": "وقت تابستانی زلاند نو"
                            }
                        },
                        "Newfoundland": {
                            "long": {
