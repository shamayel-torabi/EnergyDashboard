...
{
    public static void AddMediatRClasses(IServiceCollection services, MessageBusConfiguration configuration)
    {
        var assembliesToScan = configuration.AssembliesToRegister.Distinct().ToArray();

        ConnectImplementationsToTypesClosing(typeof(IMessageHandler<>), services, assembliesToScan, true, configuration);

        var multiOpenInterface = typeof(IMessageHandler<>);
    ...
    public static void AddRequiredServices(IServiceCollection services, MessageBusConfiguration serviceConfiguration)
    {
