...
namespace EnergyDashboard.Common.Data;

public static class WebApplicationExtensions
{
    public static bool IsInKubernetes(this WebApplication webHost)
    {
    ...
    public static void MigrateDbContext<TContext>(this WebApplication webHost, Action<TContext, IServiceProvider> seeder) where TContext : DbContext
    {
