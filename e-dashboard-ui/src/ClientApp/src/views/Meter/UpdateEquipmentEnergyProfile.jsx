...
const UpdateEquipmentEnergyProfile =(props) =>{
    const now = Date.now();
    ...
    const updateEquipmentEnergyProfile = async () => {
        ...
        const url = `${apiUrl}/EnergyProfiles/UpdateEquipmentEnergy/${equipmentId}/${startDate}/${endDate}/${updateRecords}`;
    ...
    const handleSubmit = async (event) => {
        ...
        await updateEquipmentEnergyProfile();
    }
...
export default UpdateEquipmentEnergyProfile;
